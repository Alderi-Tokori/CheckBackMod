...
function displayItems() {
    ...
    for (i = 1; i < items.length; i++) {
        ...
        itemBoxes[i - 1].addEventListener('click', function () {
            buyItem(parseInt(this.id))
        })
        itemBoxes[i - 1].addEventListener('mouseover', function () {
            showItemInfo(parseInt(this.id))
        })
        itemBoxes[i - 1].addEventListener('mouseout', function () {
            showItemInfo(0)
        })
        ...
        if (!game.items[i]) {
            itemBoxes[i - 1].innerHTML += "<p style='position: absolute; top: 0; left: 0; margin: 2px; color: white; font-size: 24px'>0</p>"
        } else {
        ...
        if (i > 18 && game.highestLevel <= 20000) {
            ...
            itemBoxes[i - 1].addEventListener('mouseover', function () {
                showItemHiddenInfo(parseInt(this.id))
            })
            itemBoxes[i - 1].addEventListener('mouseout', function () {
                showItemHiddenInfo(0)
            })
        }
    }
    j = items.length - 1
    ...
    if (game.items[x] >= items[x][1]) {
        ...
        if (x == 1) {
            if (game.coins >= 50 && game.pets[1] >= 20) {
                ...
                alert("Not enough items; " + numberShort(game.coins) + "/50 coins, " + game.pets[1] + "/20 Green butterflies")
                itemChosen = 0
            }
        }
        if (x == 2) {
            if (game.coins >= 100 && game.pets[10] >= 5) {
                ...
                alert("Not enough items; " + numberShort(game.coins) + "/100 coins, " + game.pets[10] + "/5 Gargoyles")
                itemChosen = 0
            }
        }
        if (x == 3) {
            if (game.coins >= 150 && game.pets[43] >= 1) {
                ...
                alert("Not enough items; " + numberShort(game.coins) + "/150 coins, " + game.pets[43] + "/1 Golden butterflies")
                itemChosen = 0
            }
        }
        if (x == 4) {
            if (game.coins >= 200 && game.pets[3] >= 20 && game.pets[18] >= 5 && game.pets[24] >= 5) {
                ...
                alert("Not enough items; " + numberShort(game.coins) + "/200 coins, " + game.pets[3] + "/20 Rats, " + game.pets[18] + "/5 Cats, " + game.pets[24] + "/5 Shiny rats")
                itemChosen = 0
            }
        }
        if (x == 5) {
            if (game.coins >= 250 && game.pets[5] >= 10 && game.pets[16] >= 3) {
                ...
                alert("Not enough items; " + numberShort(game.coins) + "/250 coins, " + game.pets[5] + "/10 Glowing spiders, " + game.pets[16] + "/3 Living roses")
                itemChosen = 0
            }
        }
        if (x == 6) {
            if (game.coins >= 500 && game.enemies[5] >= 1) {
                ...
                alert("Not enough items; " + numberShort(game.coins) + "/500 coins, " + game.enemies[5] + "/1 Armored humans beaten")
                itemChosen = 0
            }
        }
        if (x == 7) {
            if (game.coins >= 500 && game.pets[41] >= 5 && game.pets[42] >= 3) {
                ...
                alert("Not enough items; " + numberShort(game.coins) + "/500 coins, " + game.pets[41] + "/5 Eyeloons, " + game.pets[42] + "/3 Glowing jellyfishes")
                itemChosen = 0
            }
        }
        if (x == 8) {
            if (game.coins >= 500 && game.pets[4] >= 20 && game.pets[23] >= 7) {
                ...
                alert("Not enough items; " + numberShort(game.coins) + "/500 coins, " + game.pets[4] + "/20 Purple butterflies, " + game.pets[23] + "/7 Blue butterflies")
                itemChosen = 0
            }
        }
        if (x == 9) {
            if (game.coins >= 750 && game.pets[14] >= 15 && game.pets[25] >= 5) {
                ...
                alert("Not enough items; " + numberShort(game.coins) + "/750 coins, " + game.pets[14] + "/15 Large tortoises, " + game.pets[25] + "/5 Earth snakes")
                itemChosen = 0
            }
        }
        if (x == 10) {
            if (game.coins >= 250 && game.pets[6] >= 1) {
                ...
                alert("Not enough items; " + numberShort(game.coins) + "/250 coins, " + game.pets[6] + "/1 Green dragon")
                itemChosen = 0
            }
        }
        if (x == 11) {
            if (game.coins >= 1000 && game.pets[33] >= 5 && game.pets[29] >= 1) {
                ...
                alert("Not enough items; " + numberShort(game.coins) + "/1000 coins, " + game.pets[33] + "/5 Poisonous eyeballs, " + game.pets[29] + "/1 Spirit")
                itemChosen = 0
            }
        }
        if (x == 12) {
            if (game.coins >= 2000 && game.XPBoost >= 201 && game.pets[9] >= 20 && game.pets[32] >= 10 && game.pets[48] >= 3) {
                ...
                alert("Not enough items; " + numberShort(game.coins) + "/2000 coins, " + numberShort(game.XPBoost) + "/201 XPboost, " + game.pets[9] + "/20 Eldritch eyeballs, " + game.pets[32] + "/10 Red slimes, " + game.pets[48] + "/3 Small skeletons")
                itemChosen = 0
            }
        }
        if (x == 13) {
            if (game.coins >= 1500 && game.pets[1] >= 50 && game.pets[12] >= 3 && game.pets[43] >= 1) {
                ...
                alert("Not enough items; " + numberShort(game.coins) + "/1500 coins, " + game.pets[1] + "/50 Green butterflies, " + game.pets[12] + "/3 Red butterflies, " + game.pets[43] + "/1 Golden butterfly")
                itemChosen = 0
            }
        }
        if (x == 14) {
            if (game.coins >= 1750 && game.pets[17] >= 5 && game.pets[35] >= 5 && game.pets[19] >= 2) {
                ...
                alert("Not enough items; " + numberShort(game.coins) + "/1750 coins, " + game.pets[17] + "/5 Ice golems, " + game.pets[35] + "/5 Living trees, " + game.pets[19] + "/2 Vortex monsters")
                itemChosen = 0
            }
        }
        if (x == 15) {
            if (game.coins >= 2000 && game.pets[40] >= 25 && game.enemies[1] >= 10 && game.enemies[4] >= 2) {
                ...
                alert("Not enough items; " + numberShort(game.coins) + "/2000 coins, " + game.pets[40] + "/25 Small elfs, " + game.enemies[1] + "/10 Small humanoids beaten, " + game.enemies[4] + "/2 Nordic grandfathers beaten")
                itemChosen = 0
            }
        }
        if (x == 16) {
            if (game.coins >= 1750 && game.pets[2] >= 75 && game.pets[7] >= 30 && game.pets[15] >= 10) {
                ...
                alert("Not enough items; " + numberShort(game.coins) + "/1750 coins, " + game.pets[2] + "/75 Green lizards, " + game.pets[7] + "/30 Snakes, " + game.pets[15] + "/10 Mutant tarantulas")
                itemChosen = 0
            }
        }
        if (x == 17) {
            if (game.coins >= 2500 && game.pets[8] >= 20 && game.pets[36] >= 1 && game.pets[28] >= 1) {
                ...
                alert("Not enough items; " + numberShort(game.coins) + "/2500 coins, " + game.pets[8] + "/20 Giant fireflies, " + game.pets[36] + "/1 Fire spectral, " + game.pets[28] + "/1 Lilypad")
                itemChosen = 0
            }
        }
        if (x == 18) {
            if (game.coins >= 5000 && game.pets[56] >= 5 && game.pets[49] >= 3 && game.pets[37] >= 1) {
                ...
                alert("Not enough items; " + numberShort(game.coins) + "/5000 coins, " + game.pets[56] + "/5 Ghost rodents, " + game.pets[49] + "/3 Skeletal dogs, " + game.pets[37] + "/1 Purple star")
                itemChosen = 0
            }
        }
        if (x == 19) {
            if (game.highestLevel < 20000) {
                ...
                if (game.coins >= 15000 && game.pets[64] >= 3 && game.pets[65] >= 1) {
                    ...
                    alert("Not enough items; " + numberShort(game.coins) + "/15000 coins, " + game.pets[64] + "/3 Infected spiders, " + game.pets[65] + "/1 Red snake")
                    itemChosen = 0
                }
            }
        }
        if (x == 20) {
            if (game.highestLevel < 20000) {
                ...
                if (game.coins >= 25000 && game.enemies[6] >= 3 && game.enemies[9] >= 1) {
                    ...
                    alert("Not enough items; " + numberShort(game.coins) + "/25000 coins, " + game.enemies[6] + "/3 Stone boys beaten, " + game.enemies[9] + "/1 Magma boy beaten")
                    itemChosen = 0
                }
            }
        }
        if (x == 21) {
            if (game.highestLevel < 20000) {
                ...
                if (game.coins >= 30000 && game.pets[44] >= 3 && game.pets[66] >= 1) {
                    ...
                    alert("Not enough items; " + numberShort(game.coins) + "/30000 coins, " + game.pets[44] + "/3 2-Headed snakes, " + game.pets[66] + "/1 Dimensional eye")
                    itemChosen = 0
                }
            }
        }
        if (x == 22) {
            if (game.highestLevel < 20000) {
                ...
                if (game.coins >= 50000 && game.pets[11] >= 10 && game.pets[26] >= 5 && game.highestLevel >= 75000) {
                    ...
                    alert("Not enough items; " + numberShort(game.coins) + "/50000 coins, " + game.pets[11] + "/10 Glowing eyeballs, " + game.pets[26] + "/5 Salamanders, " + numberShort(game.highestLevel) + "/75k Highest level")
                    itemChosen = 0
                }
            }
        }
        if (x == 23) {
            if (game.highestLevel < 20000) {
                ...
                if (game.coins >= 75000 && game.pets[34] >= 10 && game.pets[27] >= 3 && game.highestLevel >= 100000) {
                    ...
                    alert("Not enough items; " + numberShort(game.coins) + "/75000 coins, " + game.pets[34] + "/10 Eyeball spiders, " + game.pets[27] + "/3 Dark snakes, " + numberShort(game.highestLevel) + "/100k Highest level")
                    itemChosen = 0
                }
            }
        }
...
function showItemHiddenInfo(x) {
    if (x == 0) {
        ...
        if (x == 19) {
            document.getElementById("shopInfo").innerHTML = "<br><br><center><p style='color: white'><span style='font-size: 32px; font-weight: bold'> Reach level 20k to Unlock"
        }
        if (x == 20) {
            document.getElementById("shopInfo").innerHTML = "<br><br><center><p style='color: white'><span style='font-size: 32px; font-weight: bold'> Reach level 20k to Unlock"
        }
...
function itemBoosts() {
    result = ""
    if (game.itemXP > 1) {
        result += "XP gain x" + numberShort(game.itemXP) + "<br>"
    }
    if (game.itemStat > 1) {
        result += "Stat gain x" + numberShort(game.itemStat) + "<br>"
    }
    if (game.itemXPBoost > 1) {
        result += "XPBoost gain x" + numberShort(game.itemXPBoost) + "<br>"
    }
    if (game.itemCooldown > 1) {
        result += "All button cooldown /" + numberShort(game.itemCooldown) + "<br>"
    }
    if (game.itemLoot > 1) {
        result += "Fighting loot x" + numberShort(game.itemLoot) + "<br>"
    }
    if (game.itemXPBoostEffectSoftcap > 0) {
        result += "XPBoost effect exponent +" + numberShort(game.itemXPBoostEffectSoftcap) + "<br>"
    }
    if (game.itemDailyXP > 1) {
        result += "Daily XP x" + numberShort(game.itemDailyXP) + "<br>"
    }
    if (game.extraPetAmount > 0) {
        result += "Extra pets: " + levelShort(game.extraPetAmount) + " <br>"
    }
    return result
}
