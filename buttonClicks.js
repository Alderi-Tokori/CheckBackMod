...
const buttons = [
    ...
    new UnboxPetButton(".unboxPrestigePetsButton", () => game.highestLevel >= 125, 3600, 0, 0, 7, "prestige"),
    new UnboxPetButton(".unboxTranscendantPetsButton", () => game.highestLevel >= 350, 3600, 0, 0, 8, "transcendant"),
    new UnboxPetButton(".unboxUniversalPetsButton", () => game.highestLevel >= 20000, 43200, 0, 0, 9, "universal"),
    ...
    new StatButton(".StatButton1", () => game.highestLevel >= 500, 5, 3600),
    new StatButton(".StatButton2", () => game.highestLevel >= 50000, 20, 21600),
];
